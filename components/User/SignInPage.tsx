        ...
        <div className="flex flex-col p-4 my-4 space-y-4 bg-white border rounded">
            ...
            {providers.map((provider: any) => {
              ...
              return (
                <div
                  ...
                  key={provider.name}
                  className="flex items-center w-full p-2 mx-2 mt-3 bg-white border cursor-pointer rounded-xl md:mt-1"
                >
                  <Image
          ...
          >
            <div className="flex items-center">
              ...
              />
              <span className="ml-1 text-blue-500 hover:text-amazon-orange hover:underline">
                Need help?
              </span>
            </div>
            {needHelp && (
