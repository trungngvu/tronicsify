...
const ConstrainCheck = ({ cart }: any) => {
  const psu = cart.find((item: any) => item.category === "psu");
  const cpu = cart.find((item: any) => item.category === "cpu");
  const ram = cart.filter((item: any) => item.category === "ram");
  const main = cart.find((item: any) => item.category === "main");
  const ramCheck = ram.find((ram: any) => ram.ram != main?.ram);
  const pcCase = cart.find((item: any) => item.category === "case");
