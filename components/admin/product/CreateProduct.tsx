...
const CreateProduct = ({
  ...
  return (
    <div className="my-4">
      <div className="flex p-2 pb-1 font-semibold border-b">
        Create a Product
      </div>
          ...
          <Form>
            ...
            <div className="flex flex-col">
              <div className="flex items-center space-x-2">
                ...
                {product.color.color && (
                  <span
                    className="w-12 h-12 my-2 rounded-full shadow"
                    style={{
            ...
            <div className="flex flex-col">
              <h3 className="p-2 pb-1 font-semibold border-b">Basic info</h3>
              <InputAdmin
                type="text"
                name="name"
                label="Name"
            ...
            <button
              disabled={loading}
              type="submit"
              className={`my-4 w-52 py-2 px-4 rounded text-white ${
                loading ? " bg-slate-400 " : "bg-green-500"
              }`}
            >
